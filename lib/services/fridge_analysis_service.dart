...
class FridgeAnalysisService {
  ...
  String _buildPrompt(List<String> all, List<String> imminent) {
    return '''
당신은 냉장고를 분석하는 AI입니다. 사용자의 보유 식재료를 보고 간단히 분석해주세요.
...
다음 형식으로 정확히 응답해주세요. 설명, 인사말, 추가 텍스트 절대 작성하지 마세요.

재료 균형: <영양 균형이나 재료 비중을 한 줄로. 예: "단백질 부족, 채소 풍부">
추천 요리: <어떤 종류의 요리가 적합한지 한 줄로. 예: "볶음, 찌개">

각 줄은 18자 이내로 짧게 작성하세요.
''';
  }
